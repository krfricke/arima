...
mod test_acf {
    ...
    fn acf_cor_full_f64() {
        ...
        let x = vec![99.97373, 104.86273, 103.04437, 105.23321, 101.36082, 99.22805, 92.31765, 94.61127, 94.22430, 99.60984, 96.72139, 91.98367];
        // auto covariance
        let acf_real = vec![1.00000000, 0.55427461, 0.29371463, 0.01633382, -0.08451876, -0.17848494, -0.23629592, -0.25075333, -0.22019925, -0.16872200, -0.18673763];
    ...
    fn acf_cov_maxlag_f64() {
        ...
        let acf_calc = arima::acf::acf(&x, Some(8), true);

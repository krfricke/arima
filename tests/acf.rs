...
mod test_acf {
    ...
    const AR3_COR: [f64; 20] = [
        1.0, 0.3592447603, -0.0829015382, -0.1133314351, 0.0044486631,
        -0.0038713998, -0.1672560659, 0.0014017379, 0.2630181693, 0.1733800793,
        -0.1281310184, -0.1007529581, 0.0503572835, -0.0227804107, -0.2575441171,
        -0.1645560738, -0.0715102441, 0.0684177063, -0.1062164941, -0.2014166444
    ];
    const AR3_COV: [f64; 20] = [
        2065.0573327104, 741.8610264385, -171.196429437, -234.0359111105, 9.1867444412,
        -7.9946626208, -345.3933653193, 2.8946692215, 543.1475990511, 358.0398041259,
        -264.5978990137, -208.0606349333, 103.9906776017, -47.042854152, -531.8433675447,
        -339.8177268526, -147.672753869, 141.2864860104, -219.343149901, -415.9369184917
    ];
    const AR3_PACF: [f64; 19] = [
        0.3592447603, -0.2433664279, 0.0135795645, 0.0364847159, -0.0567770304,
        -0.1726207939, 0.1776766479, 0.1898676229, -0.043490948, -0.1502576512,
        0.1089261154, 0.0038887419, -0.1299288957, -0.1737979563, 0.0670438445,
        -0.2479599317, 0.1109474805, -0.16347413, -0.1005977032
    ];
    ...
    fn ar_dl_coef_full_f64() {
        ...
        let (ar_calc, err) = arima::acf::ar_dl_rho_cov(&acf_calc, cov0, None).unwrap();

        assert_eq!(ar_real.len(), ar_calc.len());

        assert_lt!(err - 1691.7126551, 1.0e-7);
    ...
    fn ar_dl_coef_order_f64() {
        ...
        let ar_real = [0.4499776844, -0.249432051, 0.0135795645];
        let (ar_calc, err) = arima::acf::ar_dl_rho_cov(&acf_calc, cov0, Some(ORDER as u32)).unwrap();
